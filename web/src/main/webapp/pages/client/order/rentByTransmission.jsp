        ...
        <c:when test="${client.clientID > 0}">
            <div>
                <form method="POST" action="Controller">
                    <input name="page" type="hidden" value="rent_car_by_transmission"/>
                    <br/>
                    <c:forEach var="transmission" items="${transmissions}">
                        <table>
                            <tr>
                                <td width="20%"><c:out
                                        value="${transmission.transName}"/></td>

                                <td><input type="radio" id="transmission" name="transmission" class="regular-radio big-radio"
                                           value="${transmission.transId}"/></td>
                                <td width="75%"></td>
                            </tr>
                        </table>
                    </c:forEach><br/>
