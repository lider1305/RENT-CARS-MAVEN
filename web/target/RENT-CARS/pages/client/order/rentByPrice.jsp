        ...
        <c:when test="${client.clientID > 0}">
            <div>
                <form method="POST" action="Controller">
                    ...
                    <br/>
                    <a href="${pageContext.servletContext.contextPath}/Controller?page=list_of_all_cars" id="allCar">
                        <h2>
                    ...
                    <c:forEach var="car" items="${cars}">
                     ...
                     : Год выпуска ${car.yearOfManufacture} : стоимость  ${car.amount} у.е. : ${car.status}"/></td>
